...
├── server.py           # FastMCP server with 10 MCP tools + 1 resource
...
The 10 MCP tools are the public API. Each tool resolves defaults, picks the right access method, and returns typed results.
